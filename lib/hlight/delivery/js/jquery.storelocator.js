...
<<<<<<< HEAD
                	var web = "http://cs-ext.jdsports.co.uk/store/"+name.replace(/\s+/g, '-')+"/"+id+"/";
=======
                	var web = "http://www.jdsports.co.uk/store/"+name.replace(/\s+/g, '-')+"/"+id+"/";
>>>>>>> dc1ad65f88d87f12afab44c3f28e23b7b674088e
...
<<<<<<< HEAD
        ...
        var tmpLatLng = new google.maps.LatLng(point.jb, point.kb);
