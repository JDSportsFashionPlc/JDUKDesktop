...
// 
	...
	var hashtag 		= 'CROSSTOWNRUNNING';
	var clientId 	= '6ed1a5eb8c7043e1b059caecbb4b4ab2';
		...
		success: function (x) {
			...
			for (var i = 0; i < x.data.length && i < limit; i++) {
				...
				// -- options are thumbnail and large - see object for more
					...
					instaHTML += "<"+instaList+"><img src='" + instaPicture + "'/></"+instaList+">";
			...
			var caroselSliderInstagram = jQuery('#instafeed').bxSlider({
				slideWidth:165,
				minSlides:2,
				maxSlides:7,
				moveSlides:5,
