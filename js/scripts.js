...
jQuery(function($) {
    ...
    // -- -- --
/* 	var newDeliveryBanner = '<style type="text/css">
	ul {
    	float: left;
   		width: 100%;
    	padding: 0;
...
/*    var newDeliveryBanner = '<style type="text/css">.delivery-mainlink,.loopClearanceText{display:none}#delivery-banner-new > div { postition: relative; float: left;  width: 30%; display: block }#delivery-banner-new { background:url("") no-repeat scroll 0 0 rgba(0, 0, 0, 0); margin: 0 auto; overflow: hidden; width: 976px; z-index: 1; }.delivery-mainlink,.loopClearanceText { letter-spacing: 0.75px; font-size:14px;color:#fff;text-transform:uppercase;text-decoration:none;line-height:39px }.delivery-mainlink:hover,.loopClearanceText:hover { text-decoration:underline }.delivery-sublink a,.delivery-sublink-extra a { margin:0 9px;font-weight:normal;font-size:12px;color:#fff; text-transform:uppercase; text-decoration:none; letter-spacing:0.39px }.delivery-sublink a:hover,.delivery-sublink-extra a:hover,.loopClearanceText a:hover { text-decoration:underline}.delivery-sublink,.delivery-sublink-extra{position:relative; top:-9px; display:none;}</style><div id="qd-b-w" style="height:120px;background:#e7e7e7; position:relative;display:none;width:100%;"><div id="delivery-banner-new" ><div class="deliverySpotTab" id="DeliverySpot1"><a class="delivery-mainlink" href="/featured/New%20In?fredhopperUrl=fh_location=%2f%2fcatalog01%2fen_GB%2fnew_arrival%3d1" manual_cm_re="USP-_-Delivery-Link-_-new-in">NEW IN</a><br /><span class="delivery-sublink"><a manual_cm_re="USP-_-Delivery-Link-_-NewInMen" href="/featured/Mens%20New%20In?fredhopperUrl=fh_location=%2f%2fcatalog01%2fen_GB%2fnew_arrival%3d1%2fcategories%3C{catalog01_ct12201}">Mens</a></span><br><span class="delivery-sublink"><a manual_cm_re="USP-_-Delivery-Link-_-NewInWomen" href="/featured/Womens New In?fredhopperUrl=fh_location=%2f%2fcatalog01%2fen_GB%2fnew_arrival%3d1%2fcategories<{catalog01_ct12202}">Womens</a></span><br><span class="delivery-sublink"><a manual_cm_re="USP-_-Delivery-Link-_-NewInKids" href="http://www.jdsports.co.uk/featured/Kids%20New%20In?fredhopperUrl=fh_location=%2f%2fcatalog01%2fen_GB%2fnew_arrival%3d1%2fcategories%3C{catalog01_ct12203}">Kids</a></span></div><div class="deliverySpotTab" id="DeliverySpot2" style="width:40%;height:102px;background:#e7e7e7 !important"><a class="delivery-mainlink" href="/page/delivery" manual_cm_re="USP-_-Delivery-Link-_-FreeStoreDel">Next Day Delivery</a><br /><span class="delivery-sublink"><a href="/page/delivery" manual_cm_re="USP-_-Delivery-Link-_-FreeNextDay"> Order by 6pm</a></span></div><div class="deliverySpotTab" id="DeliverySpot3"><a class="delivery-mainlink" href="http://www.jdsports.co.uk/featured/footwear/" manual_cm_re="USP-_-Delivery-Link-_-ClearanceFootwear">FOOTWEAR</a><br /><span class="delivery-sublink-extra"><a href="http://www.jdsports.co.uk/men/mens-footwear/" manual_cm_re="USP-_-Delivery-Link-_-FootwearMen">Men</a></span><span class="delivery-sublink-extra"><a href="http://www.jdsports.co.uk/women/womens-footwear/" manual_cm_re="USP-_-Delivery-Link-_-FootwearWomen">Women</a></span><span class="delivery-sublink-extra"><a href="http://www.jdsports.co.uk/kids/junior-footwear-(sizes-3-5.5)/" manual_cm_re="USP-_-Delivery-Link-_-FootwearKids">Kids</a></span></div></div></div>'; */
